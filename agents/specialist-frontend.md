...
the story via the tracker describing the specific blocker and apply
`specialist:blocked`. A gap you surface is feedback to the shaping tier; a gap
you paper over becomes a defect no one can see.
